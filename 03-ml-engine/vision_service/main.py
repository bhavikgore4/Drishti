...
from vision_service.core.config import settings
from vision_service.api.v1.endpoints import vision, stream, memory
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("vision_service.main:app", host="0.0.0.0", port=8002, reload=True)
