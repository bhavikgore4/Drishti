...
export const UserDashboardWorkflow: React.FC<UserDashboardWorkflowProps> = ({
  ...
  // State for all registered grievances (includes 1 Pending and 1 Completed as required)
  const [grievances, setGrievances] = useState<GrievanceRecord[]>(
    initialGrievances || [
      {
        sn: 1,
        registrationNumber: 'DRISHTI/2026/00142',
        ...
        subCategory: 'Culvert Desilting & Storm Water Drainage',
      ...
      {
        sn: 2,
        registrationNumber: 'DRISHTI/2026/00098',
        receivedDate: '02-08-2026',
        grievanceDescription: 'Damaged storm culvert wall during flash monsoon rain near Katol Road.',
        status: 'Closed',
        ministry: 'PWD Govt (Nagpur Division)',
        category: 'Infrastructure / Storm Culvert Repair',
        subCategory: 'Headwall Reconstruction',
        location: 'PWD North Division, Sadar, Nagpur',
        aiTriaged: true,
        priority: 'Medium',
        nodalOfficer: getNodalOfficerForGrievance(
          'PWD Govt (Nagpur Division)',
      ...
      {
        sn: 3,
        registrationNumber: 'DRISHTI/2026/00084',
        receivedDate: '12-08-2026',
        grievanceDescription: 'Severe water logging & storm drainage blockage in Ward 14 causing flooding risk.',
        status: 'Under Process',
        ministry: 'Nagpur Municipal Corporation (NMC)',
        category: 'Drainage & Civic Sanitation',
        subCategory: 'Culvert Blockage & Desilting',
        location: 'Dharampeth Zone, Nagpur',
        aiTriaged: true,
        priority: 'High',
        nodalOfficer: getNodalOfficerForGrievance(
          'Nagpur Municipal Corporation (NMC)',
  ...
  const [selectedTimelineDocket, setSelectedTimelineDocket] = useState<string>('DRISHTI/2026/00142');
  ...
  const handleGrievanceSubmit = (e: React.FormEvent) => {
    ...
    const newRegNumber = `DRISHTI/2026/${randomNum}`;
    const today = new Date();
    const formattedDate = `${today.getDate().toString().padStart(2, '0')}-${(today.getMonth() + 1)
      .toString()
      .padStart(2, '0')}-${today.getFullYear()}`;

    const assignedOfficer = getNodalOfficerForGrievance(
      selectedMinistry,
    ...
    const newRecord: GrievanceRecord = {
      sn: grievances.length + 1,
      registrationNumber: newRegNumber,
      receivedDate: formattedDate,
      grievanceDescription: remarks,
      status: 'Pending',
      ministry: selectedMinistry,
      category: selectedMainCategory,
      subCategory: selectedSubCategory,
      location: selectedHeadquarters,
    ...
    // Prepend new grievance so it appears on top in home dashboard
    setGrievances([newRecord, ...grievances]);
    ...
    showNotification(`Grievance registered successfully with Docket No: ${newRegNumber}`);
  };
    ...
    <div className="min-h-screen bg-[#F0F3F7] flex flex-col font-sans select-none text-gray-900">
      ...
      <header className="w-full bg-white border-b border-gray-200 px-4 sm:px-8 py-3 shadow-xs">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          >
            <NationalEmblem className="w-12 h-16 sm:w-14 sm:h-18 shrink-0" showMotto={true} />
                            ...
                            >
                              ...
                              <td className="py-3 px-4 text-center">
                                {isPendingOrActive ? (
                                  ...
                                  <div className="inline-flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-medium bg-emerald-50 text-emerald-800 border border-emerald-200/80">
                                    <CheckCircle2 size={13} className="text-emerald-600 shrink-0" />
                                    <span>Resolved - No Action Needed</span>
                                  </div>
                                )}
                              </td>
                            </tr>
                        ...
                        <tr>
                          <td colSpan={6} className="py-10 text-center text-gray-500 bg-white">
                            <div className="flex flex-col items-center justify-center gap-2">
                              ...
                              <span className="text-sm font-semibold text-gray-600">No data available in table</span>
          ...
          <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="bg-white rounded-xl max-w-3xl w-full shadow-2xl overflow-hidden border border-gray-200 flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
              ...
              <div className="bg-[#002B49] text-white p-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <NationalEmblem className="w-8 h-10" showMotto={false} />
                  <div>
