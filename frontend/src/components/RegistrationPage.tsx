...
export const RegistrationPage: React.FC<RegistrationPageProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const requiredFields = ['name', 'premiseAddress', 'state', 'pincode', 'mobileNumber', 'email', 'securityCode'];
    ...
    setIsSubmitted(true);
    setSuccessToast('Registration successful! Generating your Drishti Citizen Registration ID...');
